					  ...
					  <?php do { ?>
                        <tr>
                            ...
                            <th id="tnamap" colspan="2" align="left">
                                <?php echo $row_bahasac_page1['nama']; ?>
                            </th>
                        </tr>
                        <tr>
                            <td id="temailp" >
                                <?php echo $row_bahasac_page1['email']; ?> / <?php echo $row_bahasac_page1['website']; ?>
                            </td>
                            <td id="ttglp" align="right">
                                <?php echo date("d-m-y",$row_bahasac_page1['tanggal']); ?>
                            </td>
                        </tr>
                        <tr>
                            <td id="tkomentarp" colspan="3">
                                <?php echo $row_bahasac_page1['komentar']; ?>
                            </td>
                        </tr>
                        <tr>
                            <td id="pemisahkomentar" nowrap  border="0">&nbsp;</td>
                        </tr>
                        <?php } while ($row_bahasac_page1 = mysql_fetch_assoc($bahasac_page1)); ?>
                    </table>
            	</div>
                <div class="komentar">
